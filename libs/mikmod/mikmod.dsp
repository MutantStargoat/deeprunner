...
# ADD CPP /nologo /W1 /GX /O2 /I "include" /I "." /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "HAVE_CONFIG_H" /D "MIKMOD_STATIC" /YX /FD /c
...
# ADD CPP /nologo /W1 /Gm /GX /ZI /Od /I "include" /I "." /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "HAVE_CONFIG_H" /D "MIKMOD_STATIC" /YX /FD /GZ /c
